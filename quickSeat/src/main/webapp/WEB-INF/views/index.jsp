...
<head>
    ...
    <title>Quick Seat - Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.jsp">
                ...
                <div class="sidebar-brand-text mx-3">Quick Seat </div>
            </a>
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Yunjae Shin</span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Dashboard - Quick Seat</h1>
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">현재 좌석 이용률
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">금일 누적 이용자
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">9명</div>
                                                </div>
                                                <div class="col">
                                                    <div class="progress progress-sm mr-2">
                                                        <div class="progress-bar bg-info" role="progressbar"
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                금월 발생 매출</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">₩7,040,000</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">금주 매출 그래프</h6>
                ...
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
					  <div class="table-responsive">
					    <table class="table" id="dataTable-ex" >
					      <thead>
					        <tr>
					          <th>구분</th>
					          <th>제목</th>
					      ...
					      <tbody>
					        <tr>
					          <td>공지</td>
					          <td>스마트 체온측정/출입통제 시스템 안내(11/28마감)</td>
					          <td>2020.11.10</td>
					        </tr>
					        <tr>
					          <td>필독</td>
					          <td>시간충전권 유효기간 관련 안내</td>
					          <td>2020.11.07</td>
					        </tr>
					        <tr>
					          <td>필독</td>
					          <td>일회이용권 상품변경 등록 방법 변경</td>
					          <td>2020.11.05</td>
					        </tr>
					        <tr>
					          <td>공지</td>
					          <td>10월 진행된 시스템 기능개선 내용 알림</td>
					          <td>2020.11.02</td>
					        </tr>
					        <tr>
					          <td>작업공지</td>
					          <td>시스템 기능 개선 및 키오스크 SW 업데이트</td>
					          <td>2020.11.01</td>
					        </tr>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Quick Seat Website 2020</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
